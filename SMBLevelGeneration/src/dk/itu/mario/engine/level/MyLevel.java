...
//import dk.itu.mario.engine.level.generator.Case;
...
public class MyLevel extends Level{
    ...
    public enum Case { // column types
        ...
        public static int COUNT = Case.values().length;
